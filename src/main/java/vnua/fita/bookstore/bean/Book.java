...
public class Book {
	...
	public Book(int bookId, String title, String author, int price, int quantityInStock, String detail,
			String imagePath) {
		super();
		this.bookId = bookId;
		this.title = title;
	...
	public String toString() {
		return "Book [bookId=" + bookId + ", title=" + title + ", author=" + author + ", price=" + price
				+ ", quantityInStock=" + quantityInStock + ", detail=" + detail + ", imagePath=" + imagePath + "]";
	}
}
